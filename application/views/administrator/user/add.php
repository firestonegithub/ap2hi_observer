            ...
            <div class="animated fadeIn">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <strong class="card-title">User Add</strong>
              ...
              <div class='col-md-12'>
                 ...
                 <div id="showSupp" style="display:none">
                   <div>
                       <center><label for="exampleInputEmail1"><b><h4>Select This user can access which supplier data .. </h4></b></label></center>
                     </div><br>
                    <div class="form-row"> 
                ...
                <div id="showLanding" style="display:none">
                   <div>
                        <center><label for="exampleInputEmail1"><b><h4>Select This user can access which landing data .. </h4></b></label></center>
                     </div><br>
                    <div class="form-row"> 
                     ...
                     <?php foreach($landingLists->result() as $row ){
                        ...
                        <div class="form-group col-md-3">
                            <table>
                              <tr>
                                <td>
                              <input type='checkbox' name="landing_id[]" id="landing_id" value='<?php echo $row->kode_name; ?>' /> 
                                </td>
                                <td>
