                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="<?php echo base_url()."trip/form6/".$kode_trip; ?>"><?php echo $page_name ; ?></a></li>
 ...
 <div class="content">
            <div class="animated fadeIn">
                            ...
                            <div class="card-body">
                                ...
                                <?php 
                                 $attributes = array('class'=>'form-horizontal','role'=>'form');
                                    echo form_open_multipart('trip/form6_update/'.$kode_trip."/".$seq,$attributes); 
                                ?>
              ...
              <div class='col-md-4'>
               ...
               <a href="<?php echo base_url(); ?>trip/form6/<?php echo $kode_trip; ?>"><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
