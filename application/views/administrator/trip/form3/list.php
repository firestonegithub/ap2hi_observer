                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <a class='pull-right btn btn-success btn-sm' href='<?php echo base_url(); ?>trip/form3_add/<?php echo $kode_trip;  ?>'><span class='fa fa-plus-square-o'> </span>Tambahkan Data</a>
                                 <center><h1><a class='pull-left btn btn-warning btn-sm' href='<?php echo base_url(); ?>trip/form3_kalkulasi/<?php echo $kode_trip;  ?>'><span class='fa fa-plus-square-o'> </span>Kalkulasi</a></h1> </center>
 ...
 <table id="example2" class="display" style="width:100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <th><?php echo $CI->find_set_from_seq($key , $kode_trip , 'Tangkapan'); ?></th>
                <td><?php echo $key1; ?></td>
                <td><?php echo $value1['rata2_berat']; ?></td>
                <td><?php echo number_format(round($value1['rata2_jumlah'])); ?></td>
            </tr>
