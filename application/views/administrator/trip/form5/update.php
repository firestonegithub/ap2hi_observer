                  ...
                  <tbody>
                      ...
                      <tr>
                       ...
                       <tr>
                            ...
                            <td><input type='text' class='form-control' name='berat_umpan_non_used' id="berat_umpan_non_used" value="<?php if( !empty($post['berat_umpan_non_used']) ){ echo $post['berat_umpan_non_used']; } ?>" onkeyup="berat_umpan_non_used_1()"  autocomplete=off step=".01"></td>
                       </tr>
