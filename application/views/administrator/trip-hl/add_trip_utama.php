                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="<?php echo base_url()."/trip/list_trip_hl" ?>">Data Trip</a></li>
            ...
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        echo form_open_multipart('trip_hl/add_trip',$attributes); 
                              ?>
            ...
            <div class='col-md-4'>
                  ...
                  <tbody>
                    ...
                    <tr>
                     ...
                     <tr>
                            <th width='120px' scope='row'>Apakah kapal membawa pakura/sampan?</th>
                            <td>
                               <select class='form-control' name='hl_pakura_sampan' id="hl_pakura_sampan">
                                    <option value="">Silahkan Pilih</option>
                                    <option value="Y" <?php if( !empty($post['hl_pakura_sampan']) ){ if($post['hl_pakura_sampan'] == "Y"){ echo 'selected';  } } ?>>Ya</option>
                                    <option value="T" <?php if( !empty($post['hl_pakura_sampan']) ){ if($post['hl_pakura_sampan'] == "T"){ echo 'selected';  } } ?>>Tidak</option>
                                </select>
                            </td>
                    </tr>

                    <tr>
                            <th width='120px' scope='row'>Alat mitigasi ETP ?</th>
                            <td>
                               <select class='form-control' name='hl_mitigasi_etp' id="hl_mitigasi_etp">
                                    <option value="">Silahkan Pilih</option>
                                    <option value="Y" <?php if( !empty($post['hl_pakura_sampan']) ){ if($post['hl_mitigasi_etp'] == "Y"){ echo 'selected';  } } ?>>Ya</option>
                                    <option value="T" <?php if( !empty($post['hl_pakura_sampan']) ){ if($post['hl_mitigasi_etp'] == "T"){ echo 'selected';  } } ?>>Tidak</option>
                                </select>
                            </td>
                    </tr>

                     <tr>
                            <th width='120px' scope='row'>Nama Pemilik Perusahaan</th>
                            <td><input type='text' class='form-control' name='hl_nama_pemilik_perusahaan' id="hl_nama_pemilik_perusahaan" value="<?php if( !empty($post['hl_nama_pemilik_perusahaan']) ){ echo $post['hl_nama_pemilik_perusahaan']; } ?>" autocomplete=off></td>
                            
                    </tr>

                    <tr>
                            <th width='120px' scope='row'>Jumlah Pakura/Sampan</th>
                               <td><input type='number' class='form-control' name='hl_jumlah_pakura_sampan' id="hl_jumlah_pakura_sampan" value="<?php if( !empty($post['hl_jumlah_pakura_sampan']) ){ echo $post['hl_jumlah_pakura_sampan']; } ?>" autocomplete=off></td>
                    </tr>
               ...
               <button type='submit' name='submit' class='btn btn-info'>Tambah</button>
                <a href="<?php echo base_url(); ?>trip_hl/list_trip"><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
