                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="<?php echo base_url()."trip_hl/list_trip_hl" ?>">Data Trip</a></li>
        	...
        	<?php  foreach ($tripDetail->result_array() as $row){ ?>
             <tr>
               ...
               <td><?php echo $controller->getNamaKapalFromId($row['id_vessel']); ?></td>
                ...
                <td> <a class='btn btn-primary btn-xs' title='Edit Data' href='<?php echo base_url()."trip_hl/trip_update/".$kode_trip; ?>'><span class='fa fa-pencil-square-o'></span></a> </td>
            </tr>
           <?php } ?>
        </tbody>
        <tfoot>
              <tr>
                ...
                <th>Action </th>
                            ...
                            <div class="col-lg-12">
                                <div class="card-body">
                                	  				<div class='box-body'>
                                    	  			<a href="<?php echo base_url(); ?>trip_hl/detail_pancing/<?php echo $kode_trip; ?>" class='btn btn-app'><i class='fa fa-th'></i> Detail Pancing</a>
												    <a href="<?php echo base_url(); ?>trip_hl/alat_bantu/<?php echo $kode_trip; ?>" class='btn btn-app'><i class='fa fa-th-large'></i> Alat Bantu </a>
												    <a href="<?php echo base_url(); ?>trip_hl/palka_tuna/<?php echo $kode_trip; ?>" class='btn btn-app'><i class='fa fa-file-text'></i>Kapasitas Palka Tuna</a>
												    <a href="<?php echo base_url(); ?>trip_hl/alat_keselamatan/<?php echo $kode_trip; ?>" class='btn btn-app'><i class='fa fa-television'></i> Alat Keselamatan</a>
												    <a href="<?php echo base_url(); ?>trip_hl/informasi_lain/<?php echo $kode_trip; ?>" class='btn btn-app'><i class='fa fa-bars'></i> Informasi Lain</a>
