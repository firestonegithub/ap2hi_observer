                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <a class='pull-right btn btn-success btn-sm' href='<?php echo base_url(); ?>trip_hl/form6_add/<?php echo $kode_trip;  ?>'><span class='fa fa-plus-square-o'> </span>Tambahkan Data</a>
                            </div>
 ...
 <table id="example" class="display nowrap" style="width:100%;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>	
                	<center>
                       <a class='btn btn-primary btn-xs' title='Edit Data' href='<?php echo base_url()."trip_hl/form6_update/".$row['id_trip']."/".$row['seq']; ?>'><span class='fa fa-pencil-square-o'></span></a>
                       <a class='btn btn-danger btn-xs' title='Delete Data' href='<?php echo base_url()."trip_hl/form6_delete/".$row['id_trip']."/".$row['seq']; ?>' onclick="return confirm('Are you sure you want to delete this item?');"><span class='fa fa-power-off'></span></a>
                    </center>
                 </td>
            </tr>
