                            ...
                            <div class="card-body">
                            	...
                            	<?php 
                            	 $attributes = array('class'=>'form-horizontal','role'=>'form');
             						echo form_open_multipart('trip_hl/trip_update/'.$kode_trip,$attributes); 
                            	?>
                    ...
                    <tr>
                            ...
                            <td>
                               <select class='form-control' name='hl_pakura_sampan' id="hl_pakura_sampan">
                                    <option value="">Silahkan Pilih</option>
                                    <option value="Y" <?php if( !empty($tripDetail['hl_pakura_sampan']) ){ if($tripDetail['hl_pakura_sampan'] == "Y"){ echo 'selected';  } } ?>>Ya</option>
                                    <option value="T" <?php if( !empty($tripDetail['hl_pakura_sampan']) ){ if($tripDetail['hl_pakura_sampan'] == "T"){ echo 'selected';  } } ?>>Tidak</option>
                                </select>
                            </td>
                    </tr>
                    ...
                    <tr>
                            ...
                            <td>
                               <select class='form-control' name='hl_mitigasi_etp' id="hl_mitigasi_etp">
                                    <option value="">Silahkan Pilih</option>
                                    <option value="Y" <?php if( !empty($tripDetail['hl_pakura_sampan']) ){ if($tripDetail['hl_mitigasi_etp'] == "Y"){ echo 'selected';  } } ?>>Ya</option>
                                    <option value="T" <?php if( !empty($tripDetail['hl_pakura_sampan']) ){ if($tripDetail['hl_mitigasi_etp'] == "T"){ echo 'selected';  } } ?>>Tidak</option>
                                </select>
                            </td>
                    </tr>
                     ...
                     <tr>
                            ...
                            <td><input type='text' class='form-control' name='hl_nama_pemilik_perusahaan' id="hl_nama_pemilik_perusahaan" value="<?php if( !empty($tripDetail['hl_nama_pemilik_perusahaan']) ){ echo $tripDetail['hl_nama_pemilik_perusahaan']; } ?>" autocomplete=off></td>
                            
                    </tr>

                    <tr>
                            <th width='120px' scope='row'>Jumlah Pakura/Sampan</th>
                               <td><input type='number' class='form-control' name='hl_jumlah_pakura_sampan' id="hl_jumlah_pakura_sampan" value="<?php if( !empty($tripDetail['hl_jumlah_pakura_sampan']) ){ echo $tripDetail['hl_jumlah_pakura_sampan']; } ?>" autocomplete=off></td>
                    </tr>
